...
const Homepage = () => {
  return (
    <div className="flex h-full lg:flex-row flex-col px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
      {/* Imagen Home  */}
      ...
      <div className="h-1/2 flex flex-col gap-8 items-center justify-center  lg:h-full lg:w-1/2">
        {/* TITLE */}
        <h1 className="text-4xl font-bold md:text-7xl lg:text-8xl 2xl:text-9xl ">Jose Pedro Garcia Rojas </h1>
        {/* DES */}

        <p className="md:text-2xl text-xl lg:text-3xl ">
          Bienvenid@ a mi portafolio digita, tengo 24 años y soy de México.
        ...
        <div className="flex gap-4 w-full md:text-xl lg:text-2xl">
          <button className="p-4 rounded-lg ring-1 ring-black bg-black text-white">Ver mi trabajo</button>
